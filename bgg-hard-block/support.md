...
title: BGG Hard Block support
description: Setup, troubleshooting, and contact information for BGG Hard Block.
permalink: /bgg-hard-block/support/
---

<p class="eyebrow">Support</p>

# BGG Hard Block support

For help, email [terwox@gmail.com](mailto:terwox@gmail.com). Include your Chrome version, the extension version, and the BoardGameGeek page where the problem occurred. Do not send passwords, cookies, authorization values, or other account secrets.
...
- [Hidden Users](https://boardgamegeek.com/geekblock/list)
- [User subscription blocks](https://boardgamegeek.com/subscriptions/blocks?feedType=user)

Turning off subscription linking stops future additions. It does not remove user subscription blocks already stored by BoardGameGeek; manage those through the native editor above.
