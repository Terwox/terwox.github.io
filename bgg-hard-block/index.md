...
<div class="principles">
  ...
  <div><strong>Local processing</strong>No analytics, telemetry, developer server, remote code, or third-party sharing.</div>
  <div><strong>Native control</strong>BoardGameGeek's own Hidden Users and subscription-block editors remain available.</div>
</div>
...
<div class="button-row">
  ...
  <a class="button secondary" href="{{ '/bgg-hard-block/support/' | relative_url }}">Support</a>
</div>
